...
UFDT UFDTArr[50];       // only static memory allocation in this project
...
void man(char *name)
{
    ...
    else if(strcmp(name, "lseek") == 0)
    {
        ...
        printf("Usage : lseek File_Name ChangeInOffset STratPoint\n");
    }
...
void DisplayHelp()
{
    ...
    printf("clear : To clear all console\n");
    printf("open : To open all the file\n");
    printf("close : To close the file\n");
    printf("closeall : To close all opened files\n");
    printf("read : To read the contents from file\n");
    printf("write : To write contents into fil\n");
...
void CreateDILB()
{
    ...
    while(i <= MAXINODE)
    {
            newn = (PINODE)malloc(sizeof(INODE)); // DMA --- Dynamic Memory Allocation
...
int CreateFile(char *name, int permission)
{
    ...
    UFDTArr[i].ptrfiletable = (PFILETABLE)malloc(sizeof(FILETABLE));   // DMA
    ...
    UFDTArr[i].ptrfiletable->ptrinode->Buffer = (char *)malloc(MAXFILESIZE);   // DMA
